...
var Kino = function () {
    ...
    */
    this.addEvents = function () {
        ...
        D.on('click', '#getVideo', function () {
            K.ajax(function (data) {
                console.log(data);
            }, { 'url': 'http://gdata.youtube.com/feeds/api/videos?q=' + decodeURI('Холодное сердце') + '&alt=json&key=AI39si5Q-j_5GxpktVOrrasjQx9xgvvMCZxTtUsSmQF-65-imqDXGcVAkWP39c5kEnu9NxzbwlkS0EKIuMeBxXVov22fZEC8jA', 'reqType': 'get' });
